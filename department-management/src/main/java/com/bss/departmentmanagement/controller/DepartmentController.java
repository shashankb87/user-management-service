package com.bss.departmentmanagement.controller;
...
import com.bss.departmentmanagement.service.DepartmentService;
...
public class DepartmentController {
    ...
    @GetMapping("/{id}")
    public Department find(@PathVariable("id") Long departmentId){
